...
const AllOrders = () => {
  ...
  }, [searchTerm, platformFilter, statusFilter, orders]);
  ...
  const exportToCSV = () => {
    const headers = ['Platform', 'Customer Name', 'Phone', 'City', 'Brand', 'Product', 'Price', 'Quantity', 'Shipping', 'Total', 'Status', 'Notes', 'Created At'];
                  ...
                  <tr key={order.id} className="border-b border-primary-border hover:bg-primary-border/50">
                    <td className="py-4 px-6">
                      <span
                        ...
                        style={{
                          backgroundColor: `${PLATFORM_COLORS[order.platform]}20`,
                          color: PLATFORM_COLORS[order.platform]
                        }}
                      >
                        {order.platform}
                      </span>
                    ...
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="truncate max-w-xs">
                          ...
                          {order.brand_name && (
                            <p className="text-gray-400 text-xs">{order.brand_name}</p>
                          )}
                        </div>
                      </div>
                    </td>
